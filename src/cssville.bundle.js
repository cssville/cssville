...
var GeneratorBase = /** @class */ (function () {
    ...
    GeneratorBase.prototype.getUIComponent = function () {
        return (React.createElement("div", { className: "pb-3" }, this.name));
    };
